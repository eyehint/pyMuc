        ...
        while(True):
            ...
            if line == '':
                ...
                if  l == '$출력시작':
                    ...
                    self.player.temp_item['무기종류'] = type
                    if type == 1:
                        msg = '검'
                    elif type == 2:
                        msg = '도'
                    ...
                    if l[10:] == '이름':
                        ...
                        jung = ['철사장', '격공장', '낙화유수', '격공진력', '난화불혈수', '삼절연환', '복호장', '벽공장', '한빙장', '동해신장', '화선유불장', '청산장', '백보신권', '탄지신공', '탈명구식', '대력금강장', '반야대수인', '천세혈격', '매화난무', '혼천공', '뇌격신룡참', '무극대력', '무형일식', '난화만번', '파천검', '일지선공', '벽력진식', '추창망월', '무영신공', '교탈조화', '관음장', '삼화취정장', '천수대라인', '뇌령일식', '현천무극강', '달마삼검', '표검향우', '대비단혼강', '뇌음자흑강', '만불조종', '무극검']

                        sa = ['신천호패', '동추수', '광표권', '합마공', '혈천공', '묵혈강', '빙혈신장', '구상검', '파혈공', '풍마장', '혈산설화', '화우폭진', '녹수마장', '소수겁', '혈화비천', '현마장', '혈화장', '혈천섬광', '밀종대수인', '대수인', '혈월비적', '뇌격신룡참', '만천화우', '비혈장', '불천격뇌', '묵령대혼', '무진폭마', '격천살', '금황마라수', '수라폭', '혈지공', '잔살혈영공', '멸천혈폭', '천마폭', '천마무격신장', '수라멸', '천마검', '혈세천하']
                        if mugong in jung:
                            type = '정파'
                        elif mugong in sa:
                            type = '사파'
